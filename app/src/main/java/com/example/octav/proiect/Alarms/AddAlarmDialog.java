        ...
        View.OnClickListener clickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch (b.getId()) {
                    ...
                    case R.id.monday_button : System.out.println("Monday");
                        break;
                    case R.id.tuesday_button : System.out.println("Tuesday");
                        break;
                    case R.id.wednesday_button : System.out.println("Wednesday");
                        break;
                    case R.id.thursday_button : System.out.println("Thursday");
                        break;
                    case R.id.friday_button : System.out.println("Friday");
                        break;
                    case R.id.saturday_button : System.out.println("Saturday");
                        break;
                    case R.id.sunday_button : System.out.println("Sunday");
                        break;
